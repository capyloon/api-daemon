...
pub fn get_mime_types(ext: &str) -> Option<&'static [&'static str]> { map_lookup(&MIME_TYPES, ext).copied() }
...
fn map_lookup<'key, 'map: 'key, V>(map: &'map phf::Map<UniCase<&'static str>, V>, key: &'key str) -> Option<&'map V> {
