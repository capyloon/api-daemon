...
function install_expected(installState) {
  return {"name":"ciautotest","installState":installState,"manifestUrl":"http://ciautotest.localhost:8081/manifest.webmanifest","removable":true,"status":0,"updateState":0,"updateUrl":"http://127.0.0.1:8596/apps/manifest.webmanifest","allowedAutoDownload":false};
}

function update_expected(updateState) {
  return {"name":"ciautotest","installState":0,"manifestUrl":"http://ciautotest.localhost:8081/manifest.webmanifest","removable":true,"status":0,"updateState":updateState,"updateUrl":"http://127.0.0.1:8596/apps/manifest.webmanifest","allowedAutoDownload":false};
}
...
function status_expected(status) {
  return {"name":"ciautotest","installState":0,"manifestUrl":"http://ciautotest.localhost:8081/manifest.webmanifest","removable":true,"status":status,"updateState":0,"updateUrl":"http://127.0.0.1:8596/apps/manifest.webmanifest","allowedAutoDownload":false};
}
...
var download_failed_response_expected = {"name":"ciautotest","installState":0,"manifestUrl":"http://ciautotest.localhost:8081/manifest.webmanifest","removable":true,"status":0,"updateState":0,"updateUrl":"http://127.0.0.1:8596/apps/manifest.webmanifest","allowedAutoDownload":false};
