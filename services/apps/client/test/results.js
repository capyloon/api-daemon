...
function install_pwa_expected(installState){
  return {"name":"hellopwa","installState":installState,"manifestUrl":"https://cached.local/hellopwa/manifest.webapp","status":0,"updateState":0,"updateUrl":"https://seinlin.github.io/tests/pwa/manifest.webapp","allowedAutoDownload":false};
}
