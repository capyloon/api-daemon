...
var launcher_expected = {"name":"launcher","installState":0,"manifestUrl":"http://launcher.localhost:8081/manifest.webmanifest","removable":false,"status":0,"updateState":0,"updateManifestUrl":"","updateUrl":"","allowedAutoDownload":false};
...
function launcher_status_expected(status) {
    return {"name":"launcher","installState":0,"manifestUrl":"http://launcher.localhost:8081/manifest.webmanifest","removable":false,"status":status,"updateState":0,"updateManifestUrl":"","updateUrl":"","allowedAutoDownload":false};
}
...
var download_canceled_event = {"appsObject":{"name":"","installState":0,"manifestUrl":"http://.localhost:0/manifest.webmanifest","removable":true,"status":0,"updateManifestUrl":"http://cached.localhost:0//update.webmanifest","updateState":0,"updateUrl":"http://127.0.0.1:8596/apps/manifest.webmanifest","allowedAutoDownload":false},"reason":lib_apps.AppsServiceError.CANCELED};
